      ...
      >
        <div className="max-w-screen-xl mx-auto grid grid-areas-mobile lg:grid-areas-desktop grid-cols-1 lg:grid-cols-2 items-center gap-20">
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute top-0 right-[-4rem] w-80 h-80 bg-bvs-lightPurple rounded-full filter blur-3xl opacity-20" />
            <div className="absolute bottom-0 left-[-4rem] w-72 h-72 bg-bvs-purple rounded-full filter blur-2xl opacity-20" />
          </div>

          <div className="hidden lg:block grid-in-image ml-auto">
            <Parallax speed={-10}>
              <div className="relative w-full max-w-lg">
                <div className="absolute -top-4 -left-4 w-72 h-72 bg-bvs-purple rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob" />
                <div className="absolute -bottom-8 right-4 w-72 h-72 bg-bvs-light-purple rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-blob animation-delay-2000" />
        ...
        <div className="absolute bottom-32 md:bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
          <div className="w-10 h-16 border-2 border-bvs-accent/80 rounded-full flex justify-center mb-1">
            <div className="w-1 h-3 bg-bvs-accent/80 rounded-full mt-2 animate-scroll" />
          </div>
